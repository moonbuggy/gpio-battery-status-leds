...
from an I2C/SMbus ADC and switches from the green to red LED when the voltage
...
hard to modify these files, or create new files, to adapt for an arbitrary use.
...
## Software
### Installation
The _install.sh_ script is specific for the Freenvove Robot dog, installing
...
Bound to the robot dog control server as it is, the _check_battery.py_ script
